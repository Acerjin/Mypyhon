# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-04-16 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='Myuser.dwxx', verbose_name='部门')),
        ...
        migrations.AddField(
            model_name='dclxxb',
            name='dwmc',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='Myuser.dwxx', verbose_name='单位名称'),
        ),
        migrations.AddField(
            model_name='cljl',
            name='dwbm',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Myuser.dwxx', verbose_name='单位编码'),
        ),
    ]
